...
namespace Database
{
        ...
        public partial class Form1 : Form
        {
            ...
            private void GetMaxNumberOfRows()
            {
                ...
                string query2 = "SELECT COUNT(*) FROM TelephoneBook";
            ...
            {
                string query = "SELECT* FROM TelephoneBook ORDER BY RegDate";
                Setup(query, mySqlConnection);
            }
            ...
            private void button4_Click(object sender, EventArgs e)
            {
                ...
                string query = "SELECT * FROM TelephoneBook WHERE Name LIKE" + " '%" + s + "'";
            ...
            private void button6_Click(object sender, EventArgs e)
            {
                ...
                {
                    increment += 3;
                    string query = "SELECT * FROM TelephoneBook LIMIT 3 OFFSET " + increment;
                    Setup(query, mySqlConnection);
                }
            }
